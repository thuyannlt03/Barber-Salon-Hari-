...
import static com.example.da_1.R.drawable.button;
...
import com.example.da_1.MainActivity;
...
public class DatLichAdapter extends RecyclerView.Adapter<DatLichAdapter.ViewHolder>{
    ...
    public DatLichAdapter(Context c, ArrayList<DichVu> list,int id) {
        this.c = c;
        this.list = list;
        this.id = id;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_dkDV.setOnClickListener(new View.OnClickListener() {
            @Override
