...
public class Adapter_newsSH extends BaseAdapter {
    private Context c;
    private ArrayList<newsSH> listSH;

    public Adapter_newsSH(Context c, ArrayList<newsSH> list) {
        this.c = c;
        this.listSH = list;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewItemNews.title.setText(listSH.get(i).getTitle());
        viewItemNews.time.setText(listSH.get(i).getPubdate());
        return view;
    }
}
